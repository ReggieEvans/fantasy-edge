          ...
          <div key={m.id} className="flex items-center uppercase text-xs my-1">
            ...
            >
              <div className="flex items-center gap-2 p-2">
                <Image src={getTeamLogo(m.away_team_logo)} alt={m.away_team_name} width={30} height={30} />
            ...
            >
              <div className="flex items-center gap-2 p-2">
                ...
                <Image src={getTeamLogo(m.home_team_logo)} alt={m.home_team_name} width={30} height={30} />
              </div>
