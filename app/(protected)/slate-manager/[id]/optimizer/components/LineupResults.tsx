      ...
      <section className="space-y-3">
        ...
        <div className="flex flex-wrap gap-4">
          {lineups?.map((lineup, idx) => (
            <div key={idx} className="flex flex-col items-center border rounded-lg bg-background-secondary">
              <div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex gap-4 items-center">
                        <Image src={player.fe.team_image} alt={player.name} width={35} height={35} />
